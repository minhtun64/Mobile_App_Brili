import { TouchableOpacity, ScrollView, Text, StyleSheet, View, Image, ImageBackground } from "react-native";
                    ...
                    <View style={styles.containerOptionBtn}>
                        <ScrollView showsVerticalScrollIndicator={false}>
                            <View style={styles.newsItem}>
                                <Image style={styles.newsAvt} source={require("../../assets/images/avtNews.png")}></Image>
                                <View style={styles.newsText}>
                                    <Text style={styles.newsTitle}>Những loại thực phẩm tốt cho tiêu hóa cún nhà bạn !!!</Text>
                                    <Text style={styles.newsDes}>Mọi loài nên có một chế độ ăn uống phù hợp về mặt sinh học, và. . .</Text>
                                </View>
                            </View>
                            <View style={styles.newsItem}>
                                <Image style={styles.newsAvt} source={require("../../assets/images/avtNews.png")}></Image>
